...
.controller('DishDetailController', ['$scope', '$stateParams', 'dish', 'menuFactory', 'favoriteFactory', 'baseURL', '$ionicLoading', '$ionicPopover', '$ionicModal', '$timeout',  function($scope, $stateParams, dish, menuFactory, favoriteFactory, baseURL, $ionicLoading, $ionicPopover, $ionicModal, $timeout) {
            $scope.baseURL = baseURL;
            ...
            $scope.annotate = function ($event) {
                console.log('annotate');
                // need to popup something
...
//Customized Filter for Favorites
